    ...
    <div className="flex min-h-screen bg-slate-50">
      ...
      <div className="relative ml-64 min-h-screen flex-1 overflow-hidden">
        ...
        <main className="relative z-10 mx-auto max-w-4xl px-4 py-10 sm:px-6 lg:px-8">
          ...
          {showNewPost && (
            <div className="rounded-3xl border border-white/60 bg-white/80 p-6 shadow-2xl backdrop-blur mb-6">
              <h2 className="text-lg font-bold text-slate-900 mb-4">Create New Post</h2>
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-slate-200 bg-white/70 px-4 py-3 text-slate-900 outline-none transition focus:border-indigo-300 focus:ring-2 focus:ring-indigo-100"
                  />
                </div>
                <div>
                ...
                <button
                  ...
                  disabled={submitting}
                  className="rounded-full bg-gradient-to-r from-indigo-500 to-purple-500 px-6 py-2 text-sm font-semibold text-white shadow hover:shadow-lg transition disabled:opacity-50"
                >
                ...
                <div key={post.id} className="rounded-3xl border border-white/60 bg-white/80 shadow-xl backdrop-blur overflow-hidden">
                  ...
                  <div className="p-5">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="mt-3 flex items-center gap-3 text-sm text-slate-500">
                          <div className="flex items-center gap-2">
                            <div className="h-6 w-6 rounded-full bg-gradient-to-br from-indigo-500 to-purple-500 flex items-center justify-center text-white text-xs font-semibold">
                    ...
                    <button
                      ...
                      className="mt-4 flex items-center gap-2 text-sm font-semibold text-indigo-600 hover:text-indigo-700 transition"
                    >
                      ...
                      {post.replies && post.replies.length > 0 && (
                        <div className="divide-y divide-slate-100">
                          {post.replies.map((reply) => (
                            <div key={reply.id} className="p-4 pl-8">
                          ...
                          {replyingTo === post.id ? (
                            <div className="flex gap-2">
                              <input
                                ...
                                className="flex-1 rounded-full border border-slate-200 bg-white px-4 py-2 text-sm text-slate-900 outline-none transition focus:border-indigo-300 focus:ring-2 focus:ring-indigo-100"
                                onKeyPress={(e) => e.key === 'Enter' && handleReply(post.id)}
                              />
                              <button
                                onClick={() => handleReply(post.id)}
                                disabled={submitting}
                                className="rounded-full bg-gradient-to-r from-indigo-500 to-purple-500 p-2 text-white shadow hover:shadow-lg transition disabled:opacity-50"
                              >
