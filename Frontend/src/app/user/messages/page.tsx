...
function MessagesContent() {
  ...
  const handleSendToContact = async (contact: User) => {
    if (!messageText.trim()) {
      // Find existing conversation or start one
          ...
          <div className="p-4 border-b border-slate-100">
            <div className="flex items-center justify-between mb-3">
              ...
              <button
                ...
                className="rounded-full bg-gradient-to-r from-blue-500 to-sky-500 p-2 text-white shadow hover:shadow-lg transition"
                title="New message"
              >
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-lg border border-slate-200 bg-slate-50 pl-9 pr-3 py-2 text-sm text-slate-900 outline-none focus:border-blue-300 focus:ring-2 focus:ring-blue-100"
              />
            </div>
          </div>
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center justify-between mt-0.5">
                        ...
                        {conv.unreadCount && conv.unreadCount > 0 ? (
                          <span className="ml-2 inline-flex items-center justify-center h-5 min-w-[20px] rounded-full bg-blue-500 px-1.5 text-xs font-bold text-white flex-shrink-0">
                            {conv.unreadCount}
                          </span>
                        ) : null}
                      </div>
          ...
          {selectedConversation ? (
            <>
              ...
              <div className="p-4 border-b border-slate-200 bg-white flex items-center gap-3">
                ...
                <div className="h-10 w-10 rounded-full bg-gradient-to-br from-blue-500 to-sky-500 flex items-center justify-center text-white text-sm font-semibold">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500">
                    {getOtherParticipant(selectedConversation)?.role
                      ?.map((r) => r.roleName === 'User' ? 'Student' : r.roleName)
                      .join(', ')}
                  </p>
                </div>
              </div>
              ...
              <div className="p-4 border-t border-slate-200 bg-white">
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 rounded-full border border-slate-200 bg-slate-50 px-4 py-2.5 text-sm text-slate-900 outline-none focus:border-blue-300 focus:ring-2 focus:ring-blue-100"
                    onKeyDown={(e) => {
                  ...
                  <button
                    ...
                    className="rounded-full bg-gradient-to-r from-blue-500 to-sky-500 p-2.5 text-white shadow hover:shadow-lg transition disabled:opacity-50"
                  >
            ...
            <div className="flex-1 flex items-center justify-center">
              <div className="text-center">
                ...
                <button
                  onClick={loadContacts}
                  className="mt-4 rounded-full bg-gradient-to-r from-blue-500 to-sky-500 px-5 py-2 text-sm font-semibold text-white shadow hover:shadow-lg transition"
                >
                  New Message
                </button>
              </div>
              ...
              {filteredContacts.length === 0 ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-xs text-slate-400 mt-1">
                    You can message teachers of courses you are enrolled in
                  </p>
                </div>
              ) : (
                filteredContacts.map((contact) => (
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-500">
                        {contact.role?.map((r) => r.roleName === 'User' ? 'Student' : r.roleName).join(', ')}
                      </p>
                    </div>
                  </button>
                ))
