    ...
    <div className="flex min-h-screen bg-slate-50">
      ...
      <div className="relative ml-64 min-h-screen flex-1 overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none">
          ...
          <div className="absolute -left-12 bottom-10 h-72 w-72 rounded-full bg-gradient-to-br from-emerald-400/25 via-teal-300/25 to-cyan-300/25 blur-3xl" />
        </div>
          ...
          <div className="rounded-3xl border border-white/60 bg-white/80 p-6 shadow-2xl backdrop-blur">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              ...
              <button
                ...
                className="inline-flex justify-center rounded-full bg-gradient-to-r from-emerald-600 to-teal-500 px-4 py-2 text-sm font-semibold text-white shadow-md transition hover:shadow-lg"
              >
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                  <div>
                    ...
                    <input
                      ...
                      className="mt-1 w-full rounded-xl border border-slate-200 bg-white/70 px-3 py-2 text-slate-900 outline-none focus:border-emerald-300 focus:ring-2 focus:ring-emerald-100"
                        ...
                        <div className="flex-1">
                          <div className="flex items-center gap-2 flex-wrap">
                            ...
                            {subj.semester && (
                              <span className="rounded-full bg-purple-100 px-2 py-0.5 text-xs text-purple-700">
                                {subj.semester.name} {subj.semester.year}
                              </span>
                            )}
                          </div>
                          ...
                          {subj.teacher && (
                            <p className="mt-1 text-sm text-emerald-600">
                              Teacher: {subj.teacher.userFirstName} {subj.teacher.userLastName}
                            </p>
                          )}
                        </div>
                          ...
                          {assigningTeacher === subj.id ? (
                            <div className="flex gap-2">
                              <select
                                ...
                                className="rounded-lg border border-slate-200 px-2 py-1 text-sm outline-none focus:border-emerald-300"
                              >
                                <option value="">Select teacher</option>
                                {teachers.map((t) => (
                                  <option key={t.userEmail} value={t.userEmail}>
                                    {t.userFirstName} {t.userLastName}
                                  </option>
                                ))}
                              </select>
                              <button
                                onClick={() => handleAssignTeacher(subj.id)}
                            ...
                            <div className="flex gap-2">
                              <button
                                onClick={() => setAssigningTeacher(subj.id)}
                                className="text-sm font-semibold text-emerald-600 hover:text-emerald-700"
                              >
