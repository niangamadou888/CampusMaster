            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              <div>
                ...
                <p className="text-sm text-slate-600">
                  Stay updated on submissions, courses, and student activity.
                </p>
              </div>
              <div className="flex items-center gap-2">
                {unreadCount > 0 && (
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 rounded-full border border-slate-200 bg-white px-4 py-2 text-xs font-semibold text-slate-700 shadow-sm transition hover:border-purple-200 hover:text-purple-600"
                  >
                    <CheckCheck className="h-4 w-4" />
                    Mark all as read
                  </button>
                )}
                <span className="inline-flex items-center rounded-full bg-gradient-to-r from-purple-600 to-indigo-500 px-4 py-2 text-xs font-semibold text-white shadow-lg">
                  {unreadCount} unread
                </span>
              </div>
            </div>
                    ...
                    <div className="flex shrink-0 items-center gap-1 opacity-0 transition-opacity group-hover:opacity-100">
                      {!notif.isRead && (
                        <button
                          ...
                          className="rounded-lg p-1.5 text-slate-400 hover:bg-purple-100 hover:text-purple-600"
                          title="Mark as read"
                        >
