                ...
                {courses.map((course) => (
                  <div key={course.id} className="rounded-2xl border border-white/60 bg-white/80 p-5 shadow-sm">
                    ...
                    <div className="mt-4 flex flex-wrap gap-2">
                      ...
                      {course.isPublished ? (
                        <button onClick={() => handleUnpublish(course.id)} className="text-sm font-semibold text-amber-600 hover:text-amber-700">
                          Unpublish
                        </button>
                      ) : (
                        <button onClick={() => handlePublish(course.id)} className="text-sm font-semibold text-emerald-600 hover:text-emerald-700">
                          Publish
                        </button>
                      )}
                      <button onClick={() => handleDelete(course.id)} className="text-sm font-semibold text-red-600 hover:text-red-700">
                        Delete
                      </button>
                    </div>
                  </div>
